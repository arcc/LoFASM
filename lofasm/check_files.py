...
class LofasmFileInfo(object):
    ...
    def __init__(self, files):
        ...
        information in to a astropy table for future operation.
        Parameter
        ----------
        files : list/str
    ...
    def info_write(self, outfile):
        self.info_table.write(outfile, format='ascii.fixed_width')

if __name__=='__main__':
    c = LofasmFileInfo(['20160619_000326_AA.bbx.gz','20160619_000828_AA.bbx.gz'])
    c.info_write('se.dat')
    tt = table.Table.read('se.dat', format='ascii.fixed_width')
